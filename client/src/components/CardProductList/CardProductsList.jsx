...
const CardProductsList = () => {
  ...
  return (
    <>
      <div style={{ minHeight: "65vh" }} className="container mt-4">
          ...
          <div className="col-lg-3 col-md-12">
            {brands
              ...
              <div className="container bg-white border shadow p-3 mb-3 rounded">
                <h1>Información ⚠</h1>
                <hr />
                <p>Este proyecto está desplegado 🚀 en <a href='https://railway.app' >Railway.app</a> de manera gratuita</p>
                <p>Por lo cual en este momento no está activo el servicio, puedes mirar el <a href="https://github.com/lllariogonzalez/e-commerce">repositorio</a> y probarlo localmente. O puedes intentarlo otro día.</p>
                <small className="">Generalmente el servicio se encuentra activo del 1 al 20 de cada mes</small>
              </div>
            }
          </div>
